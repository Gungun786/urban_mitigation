...
const INITIAL_WARDS = [
  {
    ...
    priority: 'High',
    description:
      'Commercial and administrative center. Dominated by concrete plazas, high vehicular traffic, and localized asphalt corridors.',
    treeDelta: 0,
    roofDelta: 0,
    waterDelta: 0,
    energySavings: 0,
  ...
  },
  {
    ...
    priority: 'High',
    description:
      'Manufacturing cluster with extensive metal warehouse roofs, packaging facilities, low vegetation density, and high ambient heat emission.',
    treeDelta: 0,
    roofDelta: 0,
    waterDelta: 0,
    energySavings: 0,
  ...
  },
  {
    ...
    priority: 'Medium',
    description:
      'High-density multi-story residential housing societies. Moderate grid-road tree cover with developing parkway corridors.',
    treeDelta: 0,
    roofDelta: 0,
    waterDelta: 0,
    energySavings: 0,
  ...
  },
  {
    ...
    priority: 'High',
    description:
      'Densely packed commercial marketplace. Narrow lanes, high concrete building ratio, high human congestion, and severe canopy deficit.',
    treeDelta: 0,
    roofDelta: 0,
    waterDelta: 0,
    energySavings: 0,
  ...
  },
  {
    ...
    priority: 'Low',
    description:
      'Forest reserve and natural scrub land in South Delhi. Acts as a green lung, providing micro-climate cooling to surrounding neighborhoods.',
    treeDelta: 0,
    roofDelta: 0,
    waterDelta: 0,
    energySavings: 0,
    ...
    setWards(prevWards =>
      prevWards.map(w => {
        if (w.id === wardId) {
          ...
          if (w.priority === 'High') {
            return recalculateWardMetrics(w, 20, 75, 25);
    ...
    <div className="app-container">
      ...
      <header className="app-header">
        <div className="header-brand">
          ...
          <div>
            ...
            <p className="header-tagline">
              Community-first cooling insights for healthier neighborhoods.
            </p>
          </div>
          <span>v1.0.0</span>
        </div>
        ...
        <div className="header-mission">
          ...
          <p>
            Design urban heat solutions rooted in local context, green infrastructure,
        ...
        <main className="dashboard-grid">
          ...
          <section className="dashboard-panel">
            ...
            <div className="panel-card" style={{ borderLeft: '3px solid var(--color-cool)' }}>
              ...
              >
                A collaborative dashboard for communities and planners to explore
                cooling strategies. Adjust neighborhood interventions, then see the
                projected impact on heat, comfort and resilience.
              </p>
            </div>
            ...
            <div className="panel-card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                ...
                >
                  <div
                    style={{
                      background: 'hsla(220, 20%, 95%, 0.01)',
            ...
            <div className="panel-card" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              >
                Pick a neighborhood to design local cooling actions and compare their
              ...
              >
                <AlertTriangle
                  size={14}
                  style={{ color: 'var(--color-heat)', flexShrink: 0, marginTop: '2px' }}
                />
          ...
          <section className="dashboard-panel right">
            <StatsPanel selectedWard={selectedWard} cityStats={cityStats} />
